...
from Set import extract_data, resize_with_pad, IMAGE_SIZE
...
class Dataset(object):
    ...
    def read(self, img_rows=IMAGE_SIZE, img_cols=IMAGE_SIZE, img_channels=3, nb_classes=10):
        images, labels = extract_data('/media/rsit/Sharing/kaggle/train')
